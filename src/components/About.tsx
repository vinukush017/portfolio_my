      ...
      >
        ...
        <div className="bg-gray-100 dark:bg-gray-900 p-8">
          <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            ...
            <strong>4+ years of experience</strong> crafting scalable,
          ...
          <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            ...
            <strong>PostgreSQL</strong>, and DevOps tools like{" "}
            <strong>AWS S3</strong> and GitHub Actions.
          </p>

          <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            From architecting APIs that reduce load time to designing reusable
            UI components with <strong>Tailwind CSS</strong>, I aim to write
            clean, maintainable code that delivers real business value.
          </p>
